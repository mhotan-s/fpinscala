...
object List { // `List` companion object. Contains functions for creating and working with lists.
  ...
  /**
   * Replace the head of the list with a new element.
   *
   * @param l list to replace.
   * @param h The new Head element
   * @tparam A The new list with h at the head
   * @return List with head replaced
   */
  ...
  /**
   * Removes the n elements from a list
   *
   * @param l List to remove n items from
   * @param n Number of head elements to remove
   * @tparam A The type of the list
   * @return List with n elements removed.
   */
